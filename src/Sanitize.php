...
final class Sanitize
{
     ...
     *
     * Modified to preserve hyphen characters:
     *  - ASCII hyphen U+002D is excluded from the \x{2c}-\x{2f} range.
     *  - Unicode hyphens/dashes U+2010..U+2015 are excluded from the \x{2010}-\x{2027} range.
     * Keeps the class consistent with HYPHEN_PATTERN so that
     * removePunctuationBetweenNumbers() does not strip hyphens.
     */
    private const PREG_CLASS_PUNCTUATION = '\x{21}-\x{23}\x{25}-\x{2a}\x{2c}\x{2e}\x{2f}\x{3a}\x{3b}\x{3f}\x{40}\x{5b}-\x{5d}'.
        ...
        '\x{2016}-\x{2027}\x{2030}-\x{2043}\x{2045}-\x{2051}\x{2053}\x{2054}\x{2057}'.
